...
class DataAugmentation:
    ...
    def __init__(self):
        ...
        def randomGaussian(image, mean=0.2, sigma=0.3):
            #  对图像进行高斯噪声处理:param image::return:
...
def imageOps(func_name, image, des_path, file_name, times=5):
    funcMap = {"randomRotation": DataAugmentation.randomRotation,"randomCrop": DataAugmentation.randomCrop,
...
if __name__ == '__main__':
    threadOPS("/home/pic-image/train/12306train","/home/pic-image/train/12306train3")
